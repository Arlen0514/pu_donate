...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/style_nav/style_donate/style_donate.css"/>
	<%--資料檢核 --%>
                ...
                <div class="page">
                    ...
                    <div class="right no_left"><!-- 無左側選單 -->
                        ...
                        <div class="right_title">
                            <h2>我要捐款</h2>
                            <span class="enTit">Donate Now</span><!-- modify by david 20220914  -->
                        </div>
                                ...
                                <div class="valuationArea">
                                    ...
                                    <div class="form_area contact_area">
                                        ...
                                        <div class="form_list"><!--一列兩個時class內加fLType2-->
                                            ...
                                            <!--捐贈類別icon-->
                                            <div class="fL_info donateCategory_info">
                                            	<%
                                            	// 捐款類別顯示
                    							int project_count = donate_project_dms.size();
                                            	int first_max = 3;
                                                ...
                                                <%for (int i = 0; i < first_max; i++) {
					                                TableRecord donate_project_dm = donate_project_dms.get(i);
					                             	...
					                             	// 預設圖片有上傳但圖片不見，路徑寫法
					    	                    	String donate_project_dm_image = "";
					    	                    	String filePath = app_uploadpath+ "/" + "donate_category" + "/" + lang + "/" + donate_project_dm.getString("dm_icon");
					    	                    	String filePath2 = app_fetchpath+ "/" + "donate_category" + "/" + lang + "/" + donate_project_dm.getString("dm_icon");
					    	                    	File file = new File(filePath);
					    	                    
					    	                    	if(!donate_project_dm.getString("dm_icon").equals(""))
					    	                    		if(file.exists() && !file.isDirectory()) donate_project_dm_image = filePath2;
					                            %>
                                                <div class="donateCategoryItem <%=donate_project_dm.getString("dm_id").equals(default_values.get("dh_donate_project_category"))?"active":"" %>">
                                                    <input class="item_radio" type="radio" name="dh_donate_project_category" id="dc<%=i+1 %>" value="<%=donate_project_dm.getString("dm_id")%>" <%=donate_project_dm.getString("dm_id").equals(default_values.get("dh_donate_project_category"))?"checked":"" %>>
                                                    <label class="" for="dc<%=i+1 %>" >
                                                    	<%if(!"".equals(donate_project_dm_image)){ %>
                                                        <img src="<%=donate_project_dm_image %>" alt="<%=donate_project_dm.getString("dm_title") %>" title="<%=donate_project_dm.getString("dm_title") %>">
                                                        <%} %>
                                                        <h3><%=donate_project_dm.getString("dm_title") %></h3>
                                                        <span class="en"><%=donate_project_dm.getString("dm_subtitle") %></span><!-- modify by david 20220913  -->
                                                    </label>
                                                </div>
                                                <%} %>
                                                <%if(dept_dms.size()>0){ 
                                                	String department_index_image = "";
                            	                    String department_index_filePath = app_uploadpath+ "/" + "department_index" + "/" + lang + "/" + department_index.getString("dm_icon");
                            	                	String department_index_filePath2 = app_fetchpath+ "/" + "department_index" + "/" + lang + "/" + department_index.getString("dm_icon");
                            	                	File department_index_file = new File(department_index_filePath);
                            	                	
                            	                	if(!department_index.getString("dm_icon").equals(""))
                            	                		if(department_index_file.exists() && !department_index_file.isDirectory()) department_index_image = department_index_filePath2;
                                                %>
<%--                                                 <div class="donateCategoryItem <%=department_index.getString("dm_id").equals(default_values.get("dh_donate_project_category"))?"active":"" %>"> --%>
<%--                                                     <input class="item_radio" type="radio" name="dh_donate_project_category" id="dc4" value="<%=department_index.getString("dm_id")%>" <%=department_index.getString("dm_id").equals(default_values.get("dh_donate_project_category"))?"checked":"" %>> --%>
<%--                                                     <label class="" for="dc<%=4%>" > --%>
<%--                                                         <%if(!"".equals(department_index_image)){ %> --%>
<%--                                                         <img src="<%=department_index_image %>" alt="<%=department_index.getString("dm_title") %>" title="<%=department_index.getString("dm_title") %>"> --%>
<%--                                                         <%} %> --%>
<%--                                                         <h3><%=department_index.getString("dm_title") %></h3> --%>
<%--                                                         <span class="en"><%=department_index.getString("dm_subtitle") %></span><!-- modify by david 20220913  --> --%>
<!--                                                     </label> -->
<!--                                                 </div> -->
                                                <%} %>
                                                <%if(!lower_three){ %>
							 					<%for (int i = 3 ; i<donate_project_dms.size();i++) { 
							                    	TableRecord donate_project_dm = donate_project_dms.get(i);
                                                ...
                                                %>
                                                <div class="donateCategoryItem <%=donate_project_dm.getString("dm_id").equals(default_values.get("dh_donate_project_category"))?"active":"" %>">
                                                    <input class="item_radio" type="radio" name="dh_donate_project_category" id="dc<%=i+2 %>" value="<%=donate_project_dm.getString("dm_id")%>" <%=donate_project_dm.getString("dm_id").equals(default_values.get("dh_donate_project_category"))?"checked":"" %>>
                                                    <label class="" for="dc<%=i+2 %>" >
                                                        <%if(!"".equals(donate_project_dm_image)){ %>
                                                        <img src="<%=donate_project_dm_image %>" alt="<%=donate_project_dm.getString("dm_title") %>" title="<%=donate_project_dm.getString("dm_title") %>">
                                                        <%} %>
                                                        <h3><%=donate_project_dm.getString("dm_title") %></h3>
                                                ...
                                                <%} %>
                                                <%} %>
                                                <div class="donateCategoryItem <%="other".equals(default_values.get("dh_donate_project_category"))?"active":"" %>">
                                                    <input class="item_radio" type="radio" name="dh_donate_project_category" id="dc0" value="other" <%="other".equals(default_values.get("dh_donate_project_category"))?"checked":"" %>>
                                                    <label class="" for="dc0">                                                        
                                                        <img src="../donate/images/currency-exchange_07.svg" alt="">
                                                        <h3>其他</h3>
                                        ...
                                        <!--指定捐贈用途-->
                                        <div class="form_list" id="donate_project_area">
                                        	<div class="fL_tit">
					                          指定捐贈用途
					                        ...
					                        <div class="fL_info donationPurpose_info">
					                          <select id="dh_donate_project" name="dh_donate_project">
					                            ...
					                            <option value="<%=cp.getString("cp_id") %>" data-category="<%=cp.getString("cp_category") %>" <%=cp.getString("cp_id").equals(default_values.get("dh_donate_project"))?"selected":"" %>><%=cp.getString("cp_title") %></option>
					                            <%} %>
					                            <option value="other" data-category="other" <%="other".equals(default_values.get("dh_donate_project"))?"selected":"" %>>其他</option>
					                          </select>
					                          <input class="info_other" type="text" name="dh_donate_project_title" id="dh_donate_project_title" placeholder="請自行輸入指定用途" value="<%="other".equals(default_values.get("dh_donate_project"))?default_values.get("dh_donate_project_title"):"" %>" />
					                        </div>
                                        </div>
                                           
                                        <!--院系募款-->
                                        <div class="form_list deptFund" id="deptFund">
                                            <div class="fL_tit">
					                          院系募款
					                        ...
					                        <div class="fL_info donationPurpose_info">
					                          <select name="dh_donate_college" id="dh_donate_college">
					                            ...
					                            <option value="<%=dm.getString("dm_id") %>" <%=dm.getString("dm_id").equals(default_values.get("dh_donate_college"))?"selected":"" %>><%=dm.getString("dm_title") %></option>
					                            <%} %>
					                          </select>
					                          <select name="dh_donate_department" id="dh_donate_department">
					                            <option value="">請選擇系所</option>
					                            <%for(TableRecord dm:dept_sub_dms){ %>
					                            <option value="<%=dm.getString("dm_id") %>" data-category="<%=dm.getString("dm_category") %>" <%=dm.getString("dm_id").equals(default_values.get("dh_donate_department"))?"selected":"" %>><%=dm.getString("dm_title") %></option>
					                            <%} %>
					                          </select>
					                          ...
					                          <input class="info_other" type="text" name="donate_project_dept_other" id="donate_project_dept_other" placeholder="請自行輸入指定用途" value="<%="other".equals(default_values.get("dh_donate_project"))?default_values.get("dh_donate_project_title"):"" %>"/>
					                        </div>
                                        </div>    
...
<!--                                         </div>  -->
                                        ...
                                        <div class="form_list">
                                            ...
                                            <div class="fL_info captcha no_border">
                                                <input type="text" name="ind" id="ind"  onfocus="javascript:loadimage();"/>
