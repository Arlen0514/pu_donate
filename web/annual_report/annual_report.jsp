...
<% 
	// 參數設定
	String page_code 	= "annual_report", 				  		// 頁面識別碼
		   banner_code	= "annual_report",						// banner識別碼
...
<head>
	...
	<link rel="stylesheet" href="../css/style_nav/style_annual_report/style_annual_report.css">
                ...
                <div class="page">
                    ...
                    <div class="right no_left"><!-- 無左側選單 -->
                        ...
                        <div class="right_title">
                            <h2>募款年報</h2>
                            <span class="enTit">Fundraising Annual Report</span>
                        </div>
