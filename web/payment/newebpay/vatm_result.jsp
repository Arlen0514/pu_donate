...
<% 
	...
	// 交易返回值
  	...
  	String MerchantID 			= StringTool.validString(request.getParameter("MerchantID"));	// MerchantID
	...
	String StoreType 			= "";															// 繳費門市類別
	String StoreID			 	= "";															// 繳費門市代號
	String CodeNo 				= "";															// 繳費代碼
	String ExpireDate 			= "";															// 繳費截止日期
	String PayBankCode			= "";															// 付款人金融機構代碼
	String PayerAccount5Code	= "";															// 付款人金融機構帳號末五碼
	...
	// 判断JSONObject是否回繳費門市類別
	if(result.has("StoreType")) {  		
		StoreType =result.getString("StoreType");	
	}
	
	// 判断JSONObject是否回繳費門市代號
	...
	if(result.has("PayBankCode")) {  		
		ExpireDate = result.getString("PayBankCode");	
	}
	
	if(result.has("PayerAccount5Code")) {  		
		ExpireDate = result.getString("PayerAccount5Code");	
	}
	...
	// 回傳訊息
	String ph_memo = "";
	ph_memo = "回應碼：" + RespondCode + "； 回應訊息：" + Message + ";回傳記錄：" + jsonObj +  ";PayBankCode：" + PayBankCode + ";PayerAccount5Code：" + PayerAccount5Code + ";ExpireDate：" + ExpireDate;
