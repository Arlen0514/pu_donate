					...
					<td align="center" colspan="2"><table width="95%" border="0" cellspacing="1" cellpadding="0">
						<tr>
							<td class="system_bk-2bk"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
								...
								<tr class="information_table-2-1">
									<td width="15%" align="right">祝詞</td>
									<td width="85%" align="left" colspan="3">
										<input type="text" name="cp_desc" id="cp_desc" size="100" maxlength="120" value="<%=cp.getString("cp_desc")%>"/>
									</td>
								</tr>	
								
								<tr class="information_table-2-1">
									<td width="15%" align="right">致謝文字</td>
									<td width="85%" align="left" colspan="3">
										<input type="text" name="cp_content" id="cp_content" size="100" maxlength="120" value="<%=cp.getString("cp_content")%>"/>
									</td>
								</tr>			
