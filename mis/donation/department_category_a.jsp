...
<%
	...
	// 圖片建議尺寸
	String image_info = "(建議尺寸900px * 607px)";
	// 圖片建議尺寸
...
<%-- 20250331 modify Miles top menu.jsp  改成 RWD --%>
			...
			<tr>
				...
				<form name="frm" id="frm" method="post" enctype="multipart/form-data" action="<%=code%>_update.jsp?action=A&_qcategory=<%=qcategory%>&now_level=<%=now_level%>" onsubmit="javascript:return checkform(this);">
					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="information_table-2-1">
								<td width="15%" align="right">系所名稱</td>
								<td colspan="3" width="85%" align="left">
									<input type="text" name="dm_title" id="dm_title" size="137" maxlength="120" />
									<input name="dm_category" id="dm_category" type="hidden" value="<%=qcategory%>" >
								</td>
							</tr>

							<% if(now_level==1){ %>
							<tr class="information_table-2-1">
								<td width="15%" align="right">系所名稱(英文)</td>
								<td colspan="3" width="85%" align="left">
							...
							<tr class="information_table-2-1">
								<td align="right" class="information_table-2-1">系所代表圖檔</td>
