...
<%
	// 相關參數設定
	String code 		= "accumulate2";				// 功能識別碼 , 於資料庫做資料識別及模組程式檔名用
...
// 	System.out.println("donate_project :"+donate_project);
...
// 	System.out.println("-----size :"+dhs.size());
	...
	*/
	...
	/*捐贈活動*/
	Vector<TableRecord> donate_activitys = app_sm.selectAll(tblcp, "cp_code=? and cp_lang=?", new Object[] { "activity_donate", lang }, "cp_showseq ASC , " + "cp_createdate DESC");
		  ...
		  <tr>
			...
			<table width="95%"  border="0" cellspacing="1" cellpadding="0">
				...
				<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
					  ...
					  <tr class="information_bk-2">
					  	<td width="10%" align="center" class="tablebg">捐贈活動</td>
			  		  ...
			  		  <form name="form_search" method="post" action="<%=code %>.jsp" onsubmit="return checkform(this);">          
		              	<tr class="information_table-2-1">
		              		<td align="center" class="tablebg">
		                     	<select name="donate_project" id="donate_project">
		                     		<option value="all">全部</option>
		                     	<%for(TableRecord donate_activity:donate_activitys){ %>                               
		                     		<option value="<%=donate_activity.getString("cp_id") %>" 
		                     		<%=donate_project.equals(donate_activity.getString("cp_id"))?"selected":"" %>>
		                     		<%=donate_activity.getString("cp_title") %>
		                     		</option>
		                     	<%} %>
		                     	</select>
		                    </td>
