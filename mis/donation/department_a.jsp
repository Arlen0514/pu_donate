					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="information_table-2-1">
								...
								<td width="35%" align="left">
									<input type="text" name="cp_name" id="cp_name" size="45" maxlength="120" />
								</td>
								<td width="15%" align="right">聯繫窗口電話</td>
								<td width="35%" align="left">
									<input type="text" name="cp_phone" id="cp_phone" size="45" maxlength="120" />
								</td>
							</tr>
							<tr class="information_table-2-1">
								<td width="15%" align="right">聯繫窗口E-mail</td>
								<td width="35%" align="left" colspan="3">
									<input type="text" name="cp_email" id="cp_email" size="45" maxlength="255" />
								</td>
							</tr>
