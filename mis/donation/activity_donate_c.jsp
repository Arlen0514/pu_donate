							...
							<td class="system_bk-2bk"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
								...
								<tr class="information_table-2-1">
									...
									<td  width="35%" align="left">
										<input type="checkbox"  name="cp_show_goal" id="cp_show_goal" value="Y" <%="Y".equals(cp.getString("cp_show_goal")) ? "checked" : ""  %>/>
										<label for="cp_show_goal" style="color:red;">*打勾代表顯示</label>
									</td>
									<td width="15%" align="right">目標金額</td>
									<td width="35%" align="left">
										<input type="number" name="cp_goal" id="cp_goal" value="<%=cp.getInt("cp_goal") %>" min="0"
    									step="1"/>
									</td>
								</tr>						
