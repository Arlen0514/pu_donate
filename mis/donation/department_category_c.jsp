...
<%-- 20250331 modify Miles top menu.jsp  改成 RWD --%>
			...
			<tr>
				<form name="frm" id="frm" method="post" enctype="multipart/form-data" action="<%=code%>_update.jsp?action=M&dm_id=<%=dm_id %>&_qtitle=<%=qtitle %>&npage=<%=pageno %>&_qcategory=<%=qcategory%>&now_level=<%=now_level%>" onsubmit="javascript:return checkform(this);">
				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="information_table-2-1">
								<td rowspan="2" align="right" class="information_table-2-1">系所代表圖檔</td>	
