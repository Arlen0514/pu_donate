				...
				<tr>
					<td align="center" colspan="2"><table width="95%" border="0" cellspacing="1" cellpadding="0">
						<td class="system_bk-2bk"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							<tr>
								<td align="center" colspan="3" class="information_title-1"><%=show_title%>&nbsp;&nbsp;
									<%if(add_switch) { %>
...
<input type="hidden" name="cp_id" id="cp_id" value="<%=cp_id %>" />
							...
							<tr class="information_table-2-1">
								<td align="center">
									<input type="text" name="_qtitle" id="_qtitle" value="<%=qtitle %>" size="40" />
								</td>
								<td align="center">
			                    	<input type="text" name="_qemitdate" id="_qemitdate" value="<%=qemitdate %>" size="15" readonly />
		                        		~
		                    		<input type="text" name="_qrestdate" id="_qrestdate" value="<%=qrestdate %>" size="15" readonly />
		                    	</td>
		                    	<td align="center">
				...
				<tr>
					<td align="center" colspan="2"><table width="95%" border="0" cellspacing="1" cellpadding="0">
						<td class="system_bk-2bk"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							<%if(!search_switch) { %>
							<tr>
								<td align="center" colspan="6" class="information_title-1"><%=show_title%>&nbsp;&nbsp;
									<%if(add_switch) { %>
									<input type="button" value="新增資料" onclick="javascript:location.href='<%=code%>_a.jsp?category=<%=cp_id %>'" />&nbsp;
									<%} %>
									<%if(list_switch) { %>
							...
							<%} else { %>
							<tr>
								<td align="center" colspan="6" class="information_title-1"><%=show_title%>查詢列表&nbsp;&nbsp;
							</tr>
							<%} %>
...
<form name="list<%=i + 1%>" id="list<%=i + 1%>" method="post">
							...
							<td class="information_bk-2" colspan="6" align="center" height="26px">
