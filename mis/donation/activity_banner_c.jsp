...
/*--------------------------------------------------------------------------------------*/
	...
	String cp_id = ap.getString("ap_category");
%>
<!DOCTYPE html>
<html>
<head>
							...
							<td class="system_bk-2bk"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
								<tr>
									<td align="center" colspan="4" class="information_title-1"><%=show_title%>&nbsp;&nbsp;
										<%if(add_switch) { %>
										<input type="button" value="新增資料" onclick="javascript:location.href='<%=code%>_a.jsp?category=<%=cp_id %>'" />&nbsp;
										<%} %>
										<%if(list_switch) { %>
										<input type="button" value="回到列表" onclick="javascript:location.href='<%=code%>.jsp?cp_id=<%=cp_id %>'" />&nbsp;
										<%} %>
										<%if(sort_switch) { %>
										<input type="button" value="資料排序" onclick="javascript:location.href='<%=code%>_sort.jsp?category=<%=cp_id %>'" />
										<%} %>
									</td>
								</tr>
								...
								<tr class="information_table-2-1">
									...
									<td colspan="3" width="85%" align="left">
										<input type="text" name="ap_title" id="ap_title" size="130" maxlength="120" value="<%=ap.getString("ap_title")%>"/>
									</td>
								</tr>
								<tr class="information_table-2-1">
									<td align="right">圖檔說明</td>
									<td colspan="3" align="left">
										<textarea name="ap_alt" id="ap_alt" cols="108" rows="4"><%=ap.getString("ap_alt")%></textarea>
									</td>
								</tr>
								...
								<tr class="information_table-2-1">
									...
									<td colspan="3" width="85%" align="left">
										<input type="text" name="ap_desc" id="ap_desc" size="130" maxlength="120" value="<%=ap.getString("ap_desc")%>"/>
									</td>
								</tr>								
								...
								<tr class="information_table-2-1">
									...
									<td colspan="3" align="left">
										<textarea name="ap_content" id="ap_content" cols="108" rows="4"><%=ap.getString("ap_content")%></textarea>
									</td>
								</tr>
								...
								<tr class="information_table-2-1">
									...
									<td colspan="3" align="left">
										<input type="text" name="ap_url" id="ap_url" size="130" value="<%=ap.getString("ap_url")%>"/>
									</td>
								</tr>
								<tr class="information_table-2-1">
									<td rowspan="2" align="right" class="information_table-2-1">輪播圖檔</td>
		                    	...
		                    	<%if(mobile_image) { %>
								<tr class="information_table-2-1">
									<td rowspan="2" align="right" class="information_table-2-1">手機輪播圖檔</td>
									<td colspan="3" align="left" class="tablebg">&nbsp;							 
