								...
								<td class="information_table-2-1" align="left"><select
									...
									<%
										for (int i = 0; i < cps.size(); i++) {
											...
											boolean has_title = category_title_map.containsKey(cp.getString("cp_category"));
											
											String up_title = has_title?category_title_map.get(cp.getString("cp_category")):"";
									%>
									<option value="<%=cp.getString("cp_id")%>"><%=up_title %> --- <%=cp.getString("cp_title")%></option>
									<%
										}
									%>
								</select></td>
