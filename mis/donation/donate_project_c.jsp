...
<%
	// 基本參數
	String code = "donate_project"; 					// 模組識別碼
...
/*------------------------------------------------------------------------------------*/	
	...
	//所屬類別
	Vector<TableRecord> dms = app_sm.selectAll(tbldm, "dm_lang=? and dm_code=? and dm_category=?", new Object[]{ lang, "donate_category", "" } , "dm_showseq ASC , dm_createdate DESC");
							...
							<tr class="information_table-2-1">
								...
								<tr class="information_table-2-1">
									...
									<td colspan="3" align="left">
										<textarea name="cp_desc" id="cp_desc" cols="100" rows="5" class="ezEditor"><%=cp.getString("cp_desc") %></textarea>
									</td>
								</tr>
								...
								<tr class="information_table-2-1">
									<td rowspan="2" align="right" class="information_table-2-1">消息圖片</td>	
									<td colspan="3" align="left" class="tablebg">&nbsp;
							        <% if(!cp.getString("cp_image").isEmpty()){ %>
										<img src="<%=app_fetchpath+"/"+code+"/"+lang+"/"+cp.getString("cp_image")%>" width="198">		                      		
								    <% } %>
									</td>
			                    </tr>
