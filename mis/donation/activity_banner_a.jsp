...
<%
	// 基本參數
	String code = "activity_banner"; 				// 模組識別碼
	String show_title = "活動輪播圖維護";		// 模組標題
...
/*--------------------------------------------------------------------------------------*/	
	String ap_category = StringTool.validString(request.getParameter("category"));
					...
					<td align="center" colspan="2"><table width="95%" border="0" cellspacing="1" cellpadding="0">
							...
							<td class="system_bk-2bk"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
								<tr>
									<td align="center" colspan="4" class="information_title-1"><%=show_title%>&nbsp;&nbsp;
										<%if (add_switch) { %>
										<input type="button" value="新增資料" onclick="javascript:location.href='<%=code%>_a.jsp?category=<%=ap_category %>'" />&nbsp;
										<%} %>
										<%if (list_switch) { %>
										<input type="button" value="回到列表" onclick="javascript:location.href='<%=code%>.jsp?cp_id=<%=ap_category %>'" />&nbsp;
										<%} %>
										<%if (sort_switch) { %>
										<input type="button" value="資料排序" onclick="javascript:location.href='<%=code%>_sort.jsp?category=<%=ap_category %>'" />
										<%} %>
									</td>
								</tr>
								...
								<tr class="information_table-2-1">
									<td width="15%" align="right">標題(後台辨別用)</td>
									<td colspan="3" width="85%" align="left">
										<input type="text" name="ap_title" id="ap_title" size="130" maxlength="120" />
									</td>
								</tr>
								...
								<tr class="information_table-2-1">
									...
									<td colspan="3" align="left">
										<textarea name="ap_alt" id="ap_alt" cols="108" rows="4"></textarea>
									</td>
								</tr>
								
								<tr class="information_table-2-1">
									<td width="15%" align="right">輪播大標</td>
									<td colspan="3" width="85%" align="left">
										<input type="text" name="ap_desc" id="ap_desc" size="130" maxlength="120" />
									</td>
								</tr>								
								
								<tr class="information_table-2-1">
									<td align="right">輪播簡述</td>
									<td colspan="3" align="left">
										<textarea name="ap_content" id="ap_content" cols="108" rows="4"></textarea>
									</td>
								</tr>
								...
								<tr class="information_table-2-1">
									...
									<td colspan="3" align="left">
										<input type="text" name="ap_url" id="ap_url" size="130"/>
									</td>
								</tr>
								
								<tr class="information_table-2-1">
									<td align="right" class="information_table-2-1">輪播圖檔</td>
								...
								<%if(mobile_image) { %>
								<tr class="information_table-2-1">
									<td align="right" class="information_table-2-1">手機輪播圖檔</td>
									<td colspan="3" align="left" class="tablebg">
										<input name="ap_mobile" id="ap_mobile" type="file" class="button"accept="image/*"> <%=mobile_info%>
									</td>
								</tr>
								<%} %>
								...
								<tr class="information_table-2-1">
									...
									<td colspan="3" align="left">
										<input type="text" name="ap_webtitle" id="ap_webtitle" size="100" maxlength="255" value="<%=SiteSetup.getSetup("information_title"+"."+lang).getString("ss_text") %>"/>
									</td>
								</tr>
						...
						<tr align="center">
							<td colspan="4" align="center"><br />
								...
								<input type="button" value="回上一頁" onClick="location='<%=code%>.jsp?cp_id=<%=ap_category %>';">
							</td>
						</tr>
					</table></td>
</form>
