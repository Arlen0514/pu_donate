...
function checkform(F){	
	...
	if(F.cp_category.value == "") {
        ...
        alert("請輸入標題名稱!!");
        F.cp_title.focus();
    } else if (F.cp_image.value == "") {
        alert("請上傳圖檔!!");
        F.cp_image.focus();
   } else if (!file_chk.test(F.cp_image.value.toLowerCase())) {
							...
							<tr class="information_table-2-1">
								...
								<td width="35%" align="left" colspan="3">
									...
									<span id="dm_title" style="color:#FA0300;"></span>
                   					<input type="hidden" name="cp_upcategory" id="cp_upcategory" />
									<input type="hidden" name="cp_category" id="cp_category" />
...
<!-- 									<input type="text" name="cp_no" id="cp_no" size="20" maxlength="120" /> -->
<!-- 								</td> -->
							</tr>
							<tr class="information_table-2-1">
							...
							<tr class="information_table-2-1">
								...
								<td colspan="3" align="left">
									<textarea name="cp_desc" id="cp_desc" cols="100" rows="5" class="ezEditor"></textarea>
								</td>
							</tr>
							<tr class="information_table-2-1">
							...
							<tr class="information_table-2-1">
								<td align="right" class="information_table-2-1">消息圖片</td>
								<td colspan="3" align="left" class="tablebg">
									<input name="cp_image" id="cp_image" type="file" class="button" accept="image/*"> <%=image_info%>
								</td>
							</tr>
<!-- 							<tr class="information_table-2-1"> -->
...
<%-- 											<option value="<%=usage.getString("dm_id")%>"><%=usage.getString("dm_title")%></option> --%>
<%-- 										<%}%> --%>
<!-- 									</select> -->
<!-- 								</td> -->
...
<%-- 										<option value="<%=attribute.getString("dm_id")%>"><%=attribute.getString("dm_title")%></option> --%>
<%-- 										<%}%> --%>
<!-- 									</select> -->
<!-- 								</td> -->
<!-- 							</tr> -->
							...
							<tr class="information_table-2-1">
								...
								<td colspan="3" align="left">
									<input type="text" name="cp_webtitle" id="cp_webtitle" size="100" maxlength="255" value="<%=SiteSetup.getSetup("information_title"+"."+lang).getString("ss_text") %>"/>
								</td>
							</tr>
