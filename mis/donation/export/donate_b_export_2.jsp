...
session.setAttribute("donate_b_export_2_file","start");

String code = "donate";
String fileLocation = app_uploadpath + "/root/report/";
String fileName = app_account + "_donate_b_export_2.csv";
...
session.setAttribute("donate_b_export_2_file", "no");
return;
}
...
session.setAttribute("donate_b_export_2_file", "end");
%>
