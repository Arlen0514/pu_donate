...
session.setAttribute("donate_b_export_1_file","start");

String code = "donate";
String fileLocation = app_uploadpath + "/root/report/";
String fileName = app_account + "_donate_b_export_1.csv";
...
session.setAttribute("donate_b_export_1_file", "no");
return;
}
...
session.setAttribute("donate_b_export_1_file", "end");
%>
