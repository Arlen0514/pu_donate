...
/*----------------------------------------------------------------------------------*/
	...
	if(search_switch) {
		...
		sb.append("np_lang=? and np_code=? and np_title like ?");
		keys.add(lang);
		keys.add(code);
		keys.add("%" + qtitle + "%");
					...
					<td align="center" colspan="2"><table width="95%" border="0" cellspacing="1" cellpadding="0">
						<td class="system_bk-2bk"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="web_table-2-1">
	                 			<td width="50%" align="center" class="tablebg">標題名稱</td>
	                 			<td width="30%" align="center" class="tablebg">日期區間</td>
...
<form name="list_sea" id="list_sea" method="post" action="<%=code %>.jsp" onsubmit="return checkform(this);">
							<tr class="web_table-2-1">
								<td align="center">
									<input name="_qtitle" id="_qtitle" type="text" value="<%=qtitle %>" size="50" />
								</td>							
			                    <td align="center" class="tablebg">
			                     	<input type="text" name="_qemitdate" id="_qemitdate" value="<%=qemitdate %>" size="9" readonly />
		                     		~
		                       		<input type="text" name="_qrestdate" id="_qrestdate" value="<%=qrestdate %>" size="9" readonly />
		                        </td>
			                    <td align="center">
				...
				<tr>
					<td align="center" colspan="2"><table width="95%" border="0" cellspacing="1" cellpadding="0">
						<td class="system_bk-2bk"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="web_table-2-1">
								<td width="15%" align="center">項目</td>
						    	<td width="35%" align="center">標題</td>
						    	<td width="15%" align="center">上架日期</td>
						    	<td width="15%" align="center">下架日期</td>
