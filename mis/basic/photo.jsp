				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
					...
					<table width="100%" border="0" align="center" cellpadding="3"
						...
						<tr class="web_table-2-1">		
							<td width="80%" align="center">相簿名稱</td>							
						...
						<tr class="web_table-2-1">
							...
							<td align="center"><input name="_qtitle" id="_qtitle" type="text" value="<%=qtitle %>" size="90" /></td>							
		                    <td align="center">
				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
					...
					<table width="100%" border="0" align="center" cellpadding="3"
						...
						<tr class="web_table-2-1">
							...
							<td width="55%" align="center">相簿名稱</td>	
						...
						<tr class="web_table-2-1">
							...
							<td align="center">
								...
								<%} %>
								<input type="button" value="相片" onclick="goaction(this.form, '<%=code%>_in.jsp?ap_category=<%=ap.getString("ap_id")%>');" />&nbsp;
							</td>
						</tr>
						</form>
						<%} %>
