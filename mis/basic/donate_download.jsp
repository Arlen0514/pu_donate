...
<%
	// 基本參數
	String code = "donate_download"; 			// 模組識別碼
	String upload_code = "donate_download"; 	// 上傳資料夾識別碼
	String show_title = "捐款單下載"; 			// 模組標題
...
<!-- 													</tr> -->
													...
													<tr class="web_table-2-1">
														<td rowspan="2" align="right" class="web_table-2-1">pdf檔</td>
														<td colspan="3" align="left" class="tablebg">&nbsp;
															<%if(!"".equals(cp.getString("cp_image"))) { %>
															<a href="<%=app_fetchpath+"/"+code+"/"+lang+"/"+cp.getString("cp_image")%>" target="_blank"><%=cp.getString("cp_image") %></a>
															<%} %>		                      		
														</td>
							                    	</tr>
							                    	...
							                    	<tr class="web_table-2-1">
														<td colspan="3" align="left" class="tablebg">
															<input name="imgradio" type="radio" value="ucpic" checked onclick="frm.cp_image.value='';" />使用原pdf<br />
															<input name="imgradio" type="radio" value="new" />上傳新pdf
															<input name="cp_image" id="cp_image" type="file" class="button" accept="pdf/*" onclick="frm.imgradio[1].checked=true;" /><br />
															<input name="imgradio" type="radio" value="delete" onclick="frm.cp_image.value='';">
															刪除pdf <br />
														</td>
							                    	</tr>
